...
{================ 验证副图A-v2：显示修正版 ================}
{定位：本副图用于诊断基础 / 背景 / 源头。v2重点解决文字显示范围和可读性问题。}
...
fs.writeFileSync('validation-indicator-A-readable-draft.txt', `${base}${appendix}\n`, 'utf8');
console.log('generated validation-indicator-A-readable-draft.txt');
