...
DRAWTEXT(显示许可 AND 首扩宽度许可,1.28,'宽许'),COLORRED;

{A2精简说明：低区=挤压，中区=收缩，高区=迟发/宽度许可。}
`;

fs.writeFileSync('validation-indicator-A2-clean-draft.txt', formula, 'utf8');
console.log('generated validation-indicator-A2-clean-draft.txt');
