...
// Make the validation chart own the early outputs.
base = base
  .replace(
...
{================ 验证副图A-提前输出版 ================}
{定位：把A顶/A底/PCTB线提前输出，后面只追加状态柱和文字。}
...
fs.writeFileSync('validation-indicator-A-early-output-draft.txt', `${base}${appendix}\n`, 'utf8');
console.log('generated validation-indicator-A-early-output-draft.txt');
